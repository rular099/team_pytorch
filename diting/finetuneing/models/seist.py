...
def seist_l_dis(**kwargs):
    ...
    return model
def SeismogramTransformer_Tiny(**kwargs):
    """
    Large
    """
    _args = dict(
...
@register_model
def seist_tiny_dis(**kwargs):
    """Epicentral distance estimation."""
    model = SeismogramTransformer_Tiny(
        output_head=partial(
            HeadRegression,
            out_act_layer=partial(
                ScaledActivation, act_layer=nn.Sigmoid, scale_factor=500
