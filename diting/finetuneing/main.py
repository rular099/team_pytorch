...
def get_args():
    ...
    parser.add_argument("--model-arch", default="seist", type=str, metavar="MODEL_ARCH",)
    ...
    parser.add_argument("--generate-noise-rate", default=0., type=float, metavar="GEN_NOISE_RATE",
    ...
    # If use subset of dataset by name
    parser.add_argument("--use_subset", default="True", type=bool_, metavar="USE_SUBSET",
                        help="whether use subset of dataset by name (default:True)")
