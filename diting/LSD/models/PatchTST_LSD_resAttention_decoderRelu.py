...
class PatchTSTEncoder(nn.Module):
    def __init__(self, c_in, num_patch, patch_len, 
        ...
        super().__init__()
        print("PatchTST_LSD_resAttention_decoderRelu")
        torch.manual_seed(42)
        self.n_vars = c_in
...
# def VITEncoder_base_vit(mask_ratio,
#                          input_length=10000, 
#                          head_type='all',
#                          learn_pe=False,
#                          encoder_type='MAE'):
...
# def VITDecoder_base_vit(encoder_dim,
#                     input_length=10000,
#                     decoder_type='MAE'):
#     stride = 50
#     pacth_len = 50
...
if __name__ == '__main__':
    torch.manual_seed(42)  
    model = PatchTSTEncoder_base_vit(mask_ratio=0.75,
                                     res_attention=False)
    x = torch.randn(8,3,10000)
    y = model(x)